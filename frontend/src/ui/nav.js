...
/* Instruction cards: one per view, dismissable, teach the habit the view serves. */
export const guides = {
  ...
  review: { stage:'Reflect', text:'The keystone habit of the method: weekly, uninterrupted, top to bottom. The AI has gathered the evidence; you make the calls. Steps tick themselves when the data says so. Do not skip the AI audit — automatic actions are the ones to eyeball — or the wiki lint.' },
