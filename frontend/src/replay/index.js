...
const markup = () => `
  ...
  <div class="rp-legend" aria-label="Legend">
    ...
    <div class="grp"><span class="h">Wiki</span><div class="row"><span><i class="col prog"></i>Program wiki bar · height = words, in the program's colour</span></div></div>
  </div>
